...
- Tabelas:
  ...
  - `belts` (catálogo global de faixas: kind adult/kids, name, ordinal)
  ...
  - `student_plans` (vínculo aluno↔plano, `custom_price_cents?`,
    `due_day`)
  - `payments` (`reference_month`, `amount_cents`, `paid_at`)
- Enums: `belt_kind`, `student_kind`, `student_status`, `plan_kind`.
...
## References
- `cycles/Q22026/0430-product-specification/request.md`
