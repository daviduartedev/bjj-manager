...
export const DEFAULT_PLAN_ROWS = [
  { kind: "kids_1" as const, name: "Kids 1", price_cents: DEFAULT_PLAN_PRICE_CENTS.kids_1 },
  { kind: "kids_2" as const, name: "Kids 2", price_cents: DEFAULT_PLAN_PRICE_CENTS.kids_2 },
